"""
Django settings for green_term_dev_77281 project.
...
ROOT_URLCONF = 'green_term_dev_77281.urls'
...
WSGI_APPLICATION = 'green_term_dev_77281.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_term_dev_77281 API",
    "DESCRIPTION": "API documentation for green_term_dev_77281 App",
    "VERSION": "v1",
}
